...
<head>
  ...
  <title>OPAC Perpustakaan Umum dan Arsip Kota Malang - Penerbit</title>
...
<div class="container mb-2 HasilPencarian">
  ...
  <div class="row">
    <div class="col">
      <h4>Hasil Pencarian Berdasarkan Penerbit</h4>
    </div>
    <div class="col">
  ...
  <?php foreach ($sortByPenerbit as $HasilSortByPenerbit) { ?>
      ...
      <div class="row">
        <div class="col-md-2">
          <div class="card-img-bottom img-fluid" alt="Responsive image">
            <?php if (empty($HasilSortByPenerbit->Sampul)){?>
                    <img class="card-img-bottom" src="<?php echo base_url()?>gambar/buku/sampul kosong.jpg">
                    <?php } else { ?>
                    <img class="card-img-bottom" src="<?php echo base_url()?>gambar/buku/<?php echo $HasilSortByPenerbit->Sampul; ?>">
                    <?php } ?>
          </div>
        </div>
            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                <tr class="spesifik">
                  ...
                  <td><a href="<?php echo base_url('c_index/detailbuku/').urlencode(strtolower($HasilSortByPenerbit->Judul)) ?>"
                    ><?php echo $HasilSortByPenerbit->Judul?></a></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Subyek</th>
                    <td><?php echo $HasilSortByPenerbit->Subyek?></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Pengarang</th>
                    <td><?php echo $HasilSortByPenerbit->Pengarang?></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Penerbit</th>
                    <td><?php echo $HasilSortByPenerbit->Penerbit?></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Jilid</th>
                    <td><?php echo $HasilSortByPenerbit->Jilid?></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Nomor Panggilan</th>
                    <td><?php echo $HasilSortByPenerbit->NoPanggil?></td>
                  </tr>
                </tbody>
              </table>
            </div>
