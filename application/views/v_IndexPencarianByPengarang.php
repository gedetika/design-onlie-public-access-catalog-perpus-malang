...
<head>
  ...
  <title>OPAC Perpustakaan Umum dan Arsip Kota Malang - Pencarian Berdasarkan Pengarang</title>
...
<div class="container mb-2 HasilPencarian">
  ...
  <div class="efekparallaxpencarian">
    <div class="card isiparallax">
      <div class="col-md-12" id="keterangan-pengarang" style="color: black;">
        <div class="card-block SortByPengarang">
          <?php foreach ($caripengarang as $Pengarang) { ?>
          <table class="SortByPengarang table table-striped table-sm">
            <tbody>
              <tr>
                <th scope="row"> <a href="<?php echo site_url('c_index/c_SortByPengarang/').urlencode(strtolower($Pengarang->Pengarang)) ?>" style="color: black; id="SortByPengarang"><?php echo $Pengarang->Pengarang?></a>
                </th>
              </tr>
            </tbody>
          </table>
