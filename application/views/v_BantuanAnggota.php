...
<head>
  ...
  <title>Perpustakaan Malang Kota - Bantuan Anggota</title>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="description">
        <p><h3>Ketentuan Pendaftaran Anggota</h3></p>
        <p><h5>Bagi Pendaftar dengan KTP Malang Raya (Kota Malang, Kabupaten Malang, dan Kota Batu)</h5></p>
        <p>&emsp;1.&emsp;&emsp;Pendaftar menyerahkan Kartu Tanda Penduduk (KTP) yang masih berlaku kepada Petugas Pendaftaran.</p>
        <p>&emsp;2.&emsp;&emsp;Petugas Pendaftaran akan melakukan verifikasi data berdasarkan Kartu Tanda Penduduk (KTP).</p>
        <p>&emsp;3.&emsp;&emsp;Kartu Tanda Penduduk (KTP) diserahkan kembali kepada Pendaftar.</p>
        <p>&emsp;4.&emsp;&emsp;Pendaftar melakukan pengisian data diri melalui aplikasi Pendaftaran Online pada komputer yang disediakan.</p>
        <p>&emsp;5.&emsp;&emsp;Pendaftar foto setengah badan.</p>
        <p>&emsp;6.&emsp;&emsp;Kartu Anggota dicetak</p>
        <p>&emsp;7.&emsp;&emsp;Kartu Anggota diserahkan kepada Pendaftar.</p>
        <p>&emsp;8.&emsp;&emsp;Kartu Anggota langsung dapat digunakan untuk presensi, aktivasi online, peminjaman, pengembalian, perpanjang masa pinjam secara online dan akses katalog melalui website <a href="http://perpustakaan.malangkota.go.id">http://perpustakaan.malangkota.go.id .</a></p>
        <p>&emsp;9.&emsp;&emsp;Layanan GRATIS tidak dipungut biaya apapun.</p><br>

        <p><h5>Bagi Pendaftar dengan KTP Non Malang Raya</h5></p>
        <p>&emsp;1.&emsp;&emsp;Pendaftar mengisi FORMULIR PENDAFTARAN yang disediakan oleh Petugas Pendaftaran.</p>
        <p>&emsp;2.&emsp;&emsp;Formulir pendaftaran dibubuhi tanda tangan Ketua RT dan stempel RT dimana pendaftar tinggal sementara di Malang Raya.</p>
        <p>&emsp;3.&emsp;&emsp;Pendaftar menyerahkan kembali formulir pendaftaran disertai fotocopy Kartu Tanda Penduduk (KTP) yang masih berlaku.</p>
        <p>&emsp;4.&emsp;&emsp;Khusus untuk Warga Negara Asing dilampiri fotocopy paspor dan Kartu Izin Tinggal Terbatas (KITAS) yang dikeluarkan dari Kantor Imigrasi.</p>
        <p>&emsp;5.&emsp;&emsp;Petugas Pendaftaran akan melakukan verifikasi data berdasarkan Kartu Tanda Penduduk (KTP) dan atau Kartu Izin Tinggal Terbatas (KITAS).</p>
        <p>&emsp;6.&emsp;&emsp;Petugas Pendaftaran melakukan proses input data.</p>
        <p>&emsp;7.&emsp;&emsp;Pendaftar foto setengah badan.</p>
        <p>&emsp;8.&emsp;&emsp;Kartu Anggota dicetak</p>
        <p>&emsp;9.&emsp;&emsp;Kartu Anggota diserahkan kepada Pendaftar.</p>
        <p>&emsp;10.&emsp;  Kartu Anggota langsung dapat digunakan untuk presensi, aktivasi online, peminjaman, pengembalian, perpanjang masa pinjam secara online dan akses katalog melalui website <a href="http://perpustakaan.malangkota.go.id">http://perpustakaan.malangkota.go.id .</a></p>
        <p>&emsp;11.&emsp;  Layanan GRATIS tidak dipungut biaya apapun.</p><br>

        <p><h5>Bagi Pendaftar Anak Didik / Pelajar (Anak Didik / Pelajar mulai PAUD - SLTA Sederajat)</h5></p>
        <p>&emsp;1.&emsp;&emsp;Pendaftar mengisi FORMULIR PENDAFTARAN yang disediakan oleh Petugas Pendaftaran.</p>
        <p>&emsp;2.&emsp;&emsp;Formulir pendaftaran dibubuhi tanda tangan KEPALA SEKOLAH dan stempel SEKOLAH dimana anak didik / pelajar menempuh pendidikan.</p>
        <p>&emsp;3.&emsp;&emsp;Pendaftar menyerahkan kembali formulir pendaftaran disertai fotocopy Kartu Tanda Penduduk (KTP) orang tua / wali anak didik / pelajar yang masih berlaku.</p>
        <p>&emsp;4.&emsp;&emsp;Petugas pendaftaran akan melakukan verifikasi data berdasarkan Data Isian Formulir Sekolah dan Kartu Tanda Penduduk (KTP) orang tua / wali.</p>
        <p>&emsp;5.&emsp;&emsp;Petugas Pendaftaran melakukan proses input data.</p>
        <p>&emsp;6.&emsp;&emsp;Pendaftar foto setengah badan.</p>
        <p>&emsp;7.&emsp;&emsp;Kartu Anggota dicetak</p>
        <p>&emsp;8.&emsp;&emsp;Kartu Anggota diserahkan kepada Pendaftar.</p>
        <p>&emsp;9.&emsp;&emsp;Kartu Anggota langsung dapat digunakan untuk presensi, aktivasi online, peminjaman, pengembalian, perpanjang masa pinjam secara online dan akses katalog melalui website <a href="http://perpustakaan.malangkota.go.id">http://perpustakaan.malangkota.go.id .</a></p>
        <p>&emsp;10.&emsp;  Layanan GRATIS tidak dipungut biaya apapun.</p><br>
      </div>
