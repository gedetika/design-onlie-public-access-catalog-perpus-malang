...
<head>
  ...
  <title>OPAC Perpustakaan Umum dan Arsip Kota Malang - Detail Buku</title>
...
<div class="container mb-5">
  <h4>Detail Buku</h4><hr>
  <?php foreach ($detailBuku as $bukuspesifik) { ?>
  <div class="card">
    <div class="row">
      <div class="col-md-2">
        <div class="card-img-bottom img-fluid" alt="Responsive image">
          <?php if (empty($bukuspesifik->Sampul)){?>
                    <img class="card-img-bottom" src="<?php echo base_url()?>gambar/buku/sampul kosong.jpg">
                    <?php } else { ?>
                    <img class="card-img-bottom" src="<?php echo base_url()?>gambar/buku/<?php echo $bukuspesifik->Sampul; ?>">
                    <?php } ?>
        </div>
      </div>
        ...
        <table class="table table-striped">
          <tbody>
            <tr>
              ...
              <td><?php echo $bukuspesifik->Judul; ?></td>
            </tr>
            <tr>
              <th scope="row">Cetakan</th>
              <td><?php echo $bukuspesifik->Cetakan; ?></td>
            </tr>
            <tr>
              <th scope="row">Pengarang</th>
              <td><?php echo $bukuspesifik->Pengarang; ?></td>
            </tr>
            <tr>
              <th scope="row">Penerbit</th>
              <td><?php echo $bukuspesifik->Penerbit; ?></td>
            </tr>
            <tr>
              <th scope="row">Jilid</th>
              <td><?php echo $bukuspesifik->Jilid; ?></td>
            </tr>
            <tr>
              <th scope="row">Deskripsi Fisik</th>
              <td><?php echo $bukuspesifik->DeskripsiBuku; ?></td>
            </tr>
            <tr>
              <th scope="row">Bahasa</th>
              <td><?php echo $bukuspesifik->Bahasa; ?></td>
            </tr>
            <tr>
              <th scope="row">Jumlah</th>
              <td><?php echo $bukuspesifik->Jumlah; ?></td>
            </tr>
            <tr>
              <th scope="row">Nomor Panggilan</th>
              <td><?php echo $bukuspesifik->NoPanggil; ?></td>
            </tr>
          </tbody>
        </table>
      </div>
