...
<head>
  ...
  <title>Perpustakaan Malang Kota - Jenis Layanan</title>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Bentuk dan Jenis Layanan</h1>
      </div>
      <div class="description">
        <p>Jenis pelayanan yang diberikan Perpustakaan, terdiri dari:</p>
        <p>&emsp;1.&emsp;Layanan Baca Di Tempat</p>
        <p>&emsp;&emsp;&emsp;Layanan ini dapat diberikan kepada Semua Pemustaka untuk seluruh koleksi buku, baik referensi,
        koleksi buku teks, koleksi serial, hasil penelitian dan karya tulis.</p>
        <p>&emsp;2.&emsp;Layanan Peminjaman</p>
        <p>&emsp;&emsp;&emsp;Layanan ini diberikan kepada Pemustaka yang telah mendaftar dan memiliki kartu anggota perpustakaan (KTA),
        untuk koleksi umum selain koleksi Referensi.</p>
        <p>&emsp;3.&emsp;Layanan Foto Copy</p>
        <p>&emsp;&emsp;&emsp;Layanan ini diberikan kepada Pemustaka yang telah mendaftar dan memiliki kartu anggota perpustakaan (KTA),untuk koleksi umum selain koleksi Referensi.</p>
        <p>&emsp;4.&emsp;Layanan Penelusuran Informasi</p>
        <p>&emsp;&emsp;&emsp;Layanan ini diberikan kepada pengguna yang membutuhkan informasi, baik yang menyampaikan sendiri, 
        melalui telepon / faksimili dan email. Layanan Foto Copy mengikuti ketentuan yang berlaku.</p>
        <p>&emsp;5.&emsp;Layanan Perpustakaan Keliling</p>
        <p>&emsp;&emsp;&emsp;Layanan ini diberikan kepada masyarakat yang membutuhkan baca buku namun lokasi jauh dari 
          perpustakaan umum atau kesulitan akses ke perpustakaan umum.
          Layanan ini di berikan kepada masyarakat terutama sekolah, TBM, lembaga kemasyarakatan, yang sudah 
        terdaftar dan tercantum dalam jadwal kunjungan perpustakaan keliling.</p>
      </div>  
