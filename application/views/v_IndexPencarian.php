...
<head>
  ...
  <title>OPAC Perpustakaan Umum dan Arsip Kota Malang - Pencarian</title>
...
<div class="container mb-2 HasilPencarian">
  ...
  <?php 
  if (empty($results)) {
    echo '<br>'.'<div class="alert alert-danger">'.'<strong>Judul Maupun Kata Kunci Tidak di Temukan!</strong>'.'</div>';
  } else {
