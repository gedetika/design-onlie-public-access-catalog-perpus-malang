...
<head>
  ...
  <title>OPAC Perpustakaan Umum dan Arsip Kota Malang - Pencarian Berdasarkan Penerbit</title>
...
<div class="container mb-2 HasilPencarian">
  ...
  <div class="efekparallaxpencarian">
    <div class="card isiparallax">
      <div class="col-md-12" id="keterangan-penerbit" style="color: black;">
        <div class="card-block SortByPenerbit">
          <?php foreach ($caripenerbit as $Penerbit) { ?>
          <table class="SortByPengarang table table-striped table-sm">
            <tbody>
              <tr>
                <th scope="row"> <a href="<?php echo site_url('c_index/c_SortByPenerbit/').urlencode(strtolower($Penerbit->Penerbit)) ?>" style="color: black;" id="c_SortByPenerbit"><?php echo $Penerbit->Penerbit?></a>
                </th>
              </tr>
            </tbody>
          </table>
