...
<head>
  ...
  <title>Perpustakaan Malang Kota - Denah Ruangan Perpustakaan</title>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Denah Dalam Perpustakaan</h1>
      </div>
      <div class="description">
        <small>Lantai 1</small>
        <div class="row">
          <div class="col-md-10" style="text-align: left;">
            <img src="<?php echo base_url()?>bootstrap/gambar/lantai 1 b.png" class="img-fluid" style="max-width: 100%; height: auto;">
          </div>
        </div>
      </div><br>

      <div class="description">
        <small>Lantai 2</small>
        <div class="row">
          <div class="col-md-10" style="text-align: left;">
            <img src="<?php echo base_url()?>bootstrap/gambar/lantai 2 b.png" class="img-fluid" style="max-width: 100%; height: auto;">
          </div>
        </div>
      </div>
