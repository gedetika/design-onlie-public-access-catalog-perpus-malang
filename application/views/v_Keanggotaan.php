...
<head>
  ...
  <title>Perpustakaan Malang Kota - Keanggotaan</title>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="description">
        <p>Syarat Menjadi Anggota Perpustakaan (Gratis):</p>
        <p>&emsp;1.&emsp;Domisili Kota Malang :</p>
        <p>&emsp;&emsp;&emsp;a.&emsp;Menunjukkan KTP Malang</p>
        <p>&emsp;&emsp;&emsp;b.&emsp;Foto di tempat</p>
        <p>&emsp;2.&emsp;Domisili Malang Raya</p>
        <p>&emsp;&emsp;&emsp;a.&emsp;Menunjukkan KTP Kab. Malang atau KTP Kota Batu</p>
        <p>&emsp;&emsp;&emsp;b.&emsp;Foto di tempat</p>
        <p>&emsp;3.&emsp;Domisili Luar Kota</p>
        <p>&emsp;&emsp;&emsp;a.&emsp;Mengisi formulir pendaftaran yang disediakan</p>
        <p>&emsp;&emsp;&emsp;b.&emsp;Fotocopy KTP 1 lembar</p>
        <p>&emsp;&emsp;&emsp;c.&emsp;Foto di tempat</p>
        <p>&emsp;4.&emsp;Pendaftaran Online</p>
        <p>&emsp;&emsp;&emsp;a.&emsp;Buka web <a href="http://perpustakaan.malangkota.go.id">http://perpustakaan.malangkota.go.id</a></p>
        <p>&emsp;&emsp;&emsp;b.&emsp;Pilih menu pendaftaran online</p>
        <p>&emsp;&emsp;&emsp;c.&emsp;Isi semua kolom dengan lengkap, sesuai identitas pada KTP</p>
        <p>&emsp;&emsp;&emsp;d.&emsp;Kemudian silahkan datang ke perpustakaan untuk verifikasi data, pengembalian foto dan kartu anggota, dengan membawa identitas diri berupa KTP</p>
      </div>
