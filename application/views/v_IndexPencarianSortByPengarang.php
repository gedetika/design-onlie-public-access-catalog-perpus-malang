...
<head>
  ...
  <title>OPAC Perpustakaan Umum dan Arsip Kota Malang - Pengarang</title>
...
<div class="container mb-2 HasilPencarian">
  ...
  <div class="row">
    <div class="col">
      <h4>Hasil Pencarian Berdasarkan Pengarang</h4>
    </div>
    <div class="col">
  ...
  <?php foreach ($sortByPengarang as $HasilSortByPengarang) { ?>
  <!-- ganti disini untuk pencarian -->
  <div class="efekparallaxpencarian">
    <div class="card isiparallax mb-4">
      <div class="row">
        <div class="col-md-2">
          <div class="card-img-bottom img-fluid" alt="Responsive image">
            <?php if (empty($HasilSortByPengarang->Sampul)){?>
                    <img class="card-img-bottom" src="<?php echo base_url()?>gambar/buku/sampul kosong.jpg">
                    <?php } else { ?>
                    <img class="card-img-bottom" src="<?php echo base_url()?>gambar/buku/<?php echo $HasilSortByPengarang->Sampul; ?>">
                    <?php } ?>
          </div>
        </div>
            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                <tr class="spesifik">
                  ...
                  <td><a href="<?php echo base_url('c_index/detailbuku/').urlencode(strtolower($HasilSortByPengarang->Judul)) ?>"
                    ><?php echo $HasilSortByPengarang->Judul?></a></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Subyek</th>
                    <td><?php echo $HasilSortByPengarang->Subyek?></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Pengarang</th>
                    <td><?php echo $HasilSortByPengarang->Pengarang?></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Penerbit</th>
                    <td><?php echo $HasilSortByPengarang->Penerbit?></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Jilid</th>
                    <td><?php echo $HasilSortByPengarang->Jilid?></td>
                  </tr>
                  <tr>
                    <th scope="row" style="width: 20%;">Nomor Panggilan</th>
                    <td><?php echo $HasilSortByPengarang->NoPanggil?></td>
                  </tr>
                </tbody>
              </table>
            </div>
