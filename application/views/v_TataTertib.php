...
<head>
  ...
  <title>Perpustakaan Malang Kota - Tata Tertib</title>
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Tata Tertib</h1>
        </div>
        <div class="description">
          <p>PEMUSTAKA</p>
          <p>&emsp;1.&emsp;Menitipkan tas dan barang bawaan di tempat penitipan barang/loker sebelum memasuki 
          ruang baca.</p>
          <p>&emsp;2.&emsp;Mengisi Buku Presensi di Ruang baca (non Anggota) atau Scan Barcode Kartu (Anggota).</p>
          <p>&emsp;3.&emsp;Menjaga ketertiban dan ketenangan di lingkungan Perpustakaan.</p>
          <p>&emsp;4.&emsp;Menjaga Kebersihan.</p><br>
          <p>DILARANG</p>
          <p>&emsp;1.&emsp;Membawa Tas, Makanan, Minuman dan barang berbahaya ke dalam Ruang Baca<./p>
            <p>&emsp;2.&emsp;Meminjam / menggunakan kartu anggota (KTA) dari atau ke orang lain.</p>
            <p>&emsp;3.&emsp;Merusak, mengotori bahan pustaka, prasarana, dan sarana Perpustakaan.</p>
            <p>&emsp;4.&emsp;Merokok, makan, dan minum dalam ruangan.</p>
            <p>&emsp;5.&emsp;Mengambil Gambar (foto/video) tanpa seijin petugas.</p><br>
            <p>PELANGGARAN TERHADAP TATA TERTIB AKAN DEKENAKAN SANKSI.</p>
          </div>
