...
<head>
  ...
  <title>Perpustakaan Malang Kota - Denah Lokasi</title>
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Denah Lokasi</h1>
        </div>
        <div class="description">
          <p>KANTOR PERPUSTAKAAN UMUM DAN ARSIP DAERAH KOTA MALANG</p>
          <div id="googleMap" class="googleMap" style="width:100%;height:400px;"></div>

          <script>
            function myMap() {
              var mapProp= {
                center:new google.maps.LatLng(-7.9731872,112.6207131,17),
                zoom:18,
              };
          ...
          <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDfBwP82qx9CszsaWYxFBN9gZOE3fIfEgY&callback=myMap"></script>
        </div>
