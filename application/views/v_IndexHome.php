...
<head>
  ...
  <title>OPAC Perpustakaan Umum dan Arsip Kota Malang - Home</title>
  ...
  <!-- Custom css -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>bootstrap/custom css/stylehome.css">
  ...
  <script type="text/javascript" src="<?php echo base_url()?>bootstrap/custom js/scrollingpage.js"></script>
  <script type="text/javascript" src="<?php echo base_url()?>bootstrap/custom js/navbaranimated.js"></script>
  
  <script type="text/javascript">
    function KlikKoleksiTerbaru() {
...
<body>
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container" style="padding-top: 100px;">
      <div class="efekparallax">
        <h1 class="display-4 text-white" style="text-align: center;">Selamat Datang Di Katalog Online Perpustakaan Umum dan Arsip Kota Malang</h1>
        <br>
          ...
          <div role="tabpanel" class="tab-pane active" id="umum">
            ...
            <div class="container ">
              <div class="row"> 
                ...
                <div class="col-sm-offset-5 col-md-2" style="align-items: center;">
                 <button class="btn btn-outline-light btn-block btn-lg" style="margin-top: 120px; border-radius: 50px;" name="Search" type="submit" onclick="KlikKoleksiTerbaru()"><span style="font-size: 18px;">Koleksi Terbaru</span></button>
               </div>
             </div>
           </div>
          ...
          <div role="tabpanel" class="tab-pane" id="khusus">
            <div class="row text-light">
              ...
              <!-- <div class="form-group col-md-4 mt-3">
                <form action="<?php //echo site_url('c_index/tesdropdown') ?>" method = "post">
                  <label for="inputSubyek">Pencarian berdasarkan subyek</label>
                  <select id="inputJenisSubyek" name="inputJenisSubyek" class="inputJenisSubyek form-control form-control-lg" onchange="submit();">
                    <option selected disabled="Pilih jenis Koleksi">Pilih jenis Koleksi</option>
                    <option value="0">Semua</option>
                    <option value="1">Biasa</option>
                    <option value="2">Refrensi</option>
                    <option value="3">Koleksi Kecil</option>
                    <option value="4">Reserve</option>
                    <option value="5">Perundang-Undangan</option>
                    <option value="6">Perpustakaan Keliling</option>
                    <option value="7">Skripsi</option>
                    <option value="8">Braille Corner</option>
                    <option value="9">Koleksi Lama/Vintage</option>
                    <option value="10">Malang Corner</option>
                    <option value="11">Tandon</option>
                    <option value="12">Bank Indonesia</option>
                    <option value="13">Asia Fondation</option>
                  </select>
                </form>
              </div> -->
              ...
              <div class="row"> 
                <div class="col-md-5"></div>
                <div class="col-sm-offset-5 col-md-2" style="align-items: center;">
                 <button class="btn btn-outline-light btn-block btn-lg" style="margin-top: 83px; border-radius: 50px;" name="Search" type="submit" onclick="KlikKoleksiTerbaru()"><span style="font-size: 18px;">Koleksi Terbaru</span></button>
               </div>
             </div>
           </div>
              <script type="text/javascript">
  ...
  <section class="KoleksiTerbaru">
    <div class="container mb-5">
      <div class="row">
        <h4 class="Koleksi_Terbaru ml-3">Koleksi Terbaru</h4>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-12">
              <div class="card" align="center">
                <div class="card-body">
                  <div class="row">
                    <?php $i = 0; ?>
                    <?php foreach ($koleksiBaru as $newbuku) { ?>
                    <?php if ($i++ == 8){ break; ?>
                    <?php } ?>
                    <div class="col-md-3 mt-3">
                      <div class="card">

                        <?php if (empty($newbuku->Sampul)){?>
                        <img class="card-img-bottom" style="width: 100%; height: 300px;" src="<?php echo base_url()?>gambar/buku/sampul kosong.jpg">
                        <?php } else { ?>
                        <img class="card-img-bottom" style="width: 100%; height: 300px;" src="<?php echo base_url()?>gambar/buku/<?php echo $newbuku->Sampul; ?>">
                        <?php } ?>

                        <div class="card-body d-flex flex-column" style="height: 200px;">
                          <h6 class="card-title"><?php echo $newbuku->Judul?></h6>
                          <a href="<?php echo base_url('c_index/detailbuku/').urlencode(strtolower($newbuku->Judul)) ?>" class="btn btn-outline-secondary mt-auto">Lihat Buku</a>
                        </div>
            ...
            <div class="linkkoleksibaru ml-auto mr-3 mt-3">
              <a href="<?php echo site_url('c_index/c_Pagination_KoleksiBaru') ?>" class="btn btn btn-outline-secondary mb-auto">Lihat Koleksi Terbaru Lainnya</a>
            </div>
          </div>  
        </div>
      </div>
