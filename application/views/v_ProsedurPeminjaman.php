...
<head>
  ...
  <title>Perpustakaan Malang Kota - Prosedur Peminjaman</title>
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Prosedur Peminjaman</h1>
        </div>
        <div class="description">
          <p>Prosedur Peminjaman</p>
          <p>&emsp;1.&emsp;Menyerahkan kepada petugas, bahan pustaka yang dipinjam dan kartu anggota (KTA).</p>
          <p>&emsp;2.&emsp;Petugas men-scan buku dan kartu anggota dengan barcode reader.</p>
          <p>&emsp;3.&emsp;Petugas memberikan buku, kartu anggota dan slip bukti transaksi peminjaman kepada 
          peminjam.</p><br>
          <p>Prosedur Pengembalian</p>
          <p>&emsp;1.&emsp;Menyerahkan kepada petugas, bahan pustaka yang akan dikembalikan dan menyerahkan 
          kartu anggota atau struk peminjaman.</p>
          <p>&emsp;2.&emsp;Petugas men-scan buku dan kartu anggota dengan barcode reader</p>
          <p>&emsp;3.&emsp;Petugas memberikan kartu anggota (KTA) dan bukti transaksi pengembalian kepada peminjam</p>
          <p>&emsp;4.&emsp;Apabila terlambat mengembalikan pinjaman maka pemustaka dikenakan denda keterlambatan 
            pengembalian buku Rp. 500,00 (lima ratus rupiah) per hari per 1 (satu) buku sesuai Peraturan 
          Walikota Nomor 77 Tahun 2015 tentang Pelayanan Perpustakaan Pasal 12</p><br>
          <p>Prosedur Perpanjangan Pinjaman</p>
          <p>&emsp;1.&emsp;Sampaikan dengan jelas kepada petugas untuk memperpanjang buku yang akan di 
          perpanjang.</p>
          <p>&emsp;2.&emsp;Menyerahkan kepada petugas, bahan pustaka yang akan diperpanjang serta menyerahkan 
          kartu anggota (KTA) Asli. (bukan struk peminjaman saja).</p>
          <p>&emsp;3.&emsp;Petugas men-scan buku dan kartu anggota dengan barcode reader.</p>
          <p>&emsp;4.&emsp;Petugas memberikan kartu anggota (KTA) dan bukti transaksi peminjaman kepada peminjam.</p>
        </div>
