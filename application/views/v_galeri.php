...
<head>
  ...
  <script type="text/javascript" src="<?php echo base_url()?>bootstrap/custom js/galeri.js"></script>
  ...
  <link href="<?php echo base_url()?>bootstrap/custom css/album.css" rel="stylesheet">
